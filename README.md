...
| HTTP METHOD (_Verb_) | URL (_Nouns_)           | CRUD    | Response              | Notes |
| -------------------- | ----------------------- | ------- | --------------------- | ----- |
| GET                  | /books                  | READ    | Arraybooks            |       |
| PUT                  | /books/status           | UPDATE  | in/out                |       |
| GET                  | /books/:id/genres       | READ    | ArrayGenres           |       |
| GET                  | /books/status           | READ    | checkout status       |       |
| PUT                  | books/genres/:id/update | UPDATE  | change book genre     |       |
| PUT                  | genres/books/:id/update | UPDATE  | change books in genre |       |
| POST                 | genres/:id/update       | CREATE  | create book genre     |       |
| POST                 | books/:id/update        | CREATE  | create book           |       |
| DELETE               | genres/:id/update       | DESTROY | remove book genre     |       |
| DELETE               | books/:id/update        | CREATE  | remove book           |       |
